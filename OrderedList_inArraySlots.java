...
public class OrderedList_inArraySlots
    ...
    public OrderedList_inArraySlots ( ArrayList<Integer> unordered) {
        for (int index = 0; index < unordered.size(); index++){
            int firstValue = unordered.get(index);
            int secondIndex = champIndex(unordered, index);
            System.out.println("smallest element is at index " + secondIndex
            + " and has the value " + unordered.get(secondIndex));
            unordered.set(index, unordered.get(secondIndex));
            unordered.set(secondIndex, firstValue);
            System.out.println("updated list: " + unordered);
        }
        list_iAS = unordered;
    }
    ...
    /** 
      ...
      @return the index of the smallest of the elements,
              ...
              from the currentIndex to the end of the array
     */
     private int champIndex( ArrayList<Integer> list, int currentIndex) {
